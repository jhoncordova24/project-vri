                  ...
                  <div className="flex items-center gap-2 shrink-0 self-start md:self-auto max-w-full">
                    {project.linea_investigacion && (
                      <span
                        ...
                        className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-indigo-50/80 text-indigo-900 font-bold text-[11px] border border-indigo-100 max-w-[180px] sm:max-w-[280px] md:max-w-xs truncate"
                      >
                    ...
                    {project.culminado ? (
                      ...
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/80 shrink-0">
