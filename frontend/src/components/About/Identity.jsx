...
export default function Identity() {
  return (
    <SectionContainer
      ...
      title="Una visión compartida, excelencia científica y compromiso con el impacto real"
      className="bg-white"
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        >
          <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
            ...
            innovación tecnológica y la transferencia del conocimiento hacia la
            sociedad.
          </p>
      ...
      <div
        className="relative w-full h-72 sm:h-80 lg:h-96 rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200/80 group mt-10 sm:mt-14"
        data-aos="fade-up"
        data-aos-duration="800"
        data-aos-delay="300"
        data-aos-easing="ease-out-cubic"
